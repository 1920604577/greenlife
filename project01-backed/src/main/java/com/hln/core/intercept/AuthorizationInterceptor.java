package com.hln.core.intercept;

import com.alibaba.fastjson2.JSONArray;
import com.hln.core.util.JwtUtil;
import com.hln.core.util.ThreadLocalUtil;
...
//        System.err.println(requestURL);
        ...
        //用户idv4地址
//        String ipAddr = LoginUtils.getIpAddr(request);
//        Map<String, Object> ipv4 = new HashMap<>();
//        ipv4.put("ipv4", ipAddr);
//        ThreadLocalUtil.mapThreadLocalOfJWT.get().put("ipv4", ipv4);
